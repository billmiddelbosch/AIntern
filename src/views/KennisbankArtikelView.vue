    ...
    <div class="kb-artikel">
      <div class="kb-artikel__container">
        ...
        <article v-else-if="post" class="kb-artikel__article">
          ...
          <!--
            Article body — rendered from HTML generated by our own AI agents via our own S3 bucket.
            XSS risk is accepted: content origin is controlled (own agents, own S3).
          -->
          <!-- eslint-disable-next-line vue/no-v-html -->
          <div class="kb-artikel__body" v-html="post.content" />
